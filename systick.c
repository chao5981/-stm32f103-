...
/**
 * @brief 无中断类型高CPU占用高精度10us计时器(无需初始化)
 * @param 传入要延时的10us
 * @retval 无
 */
...
/**
 * @brief 无中断类型高CPU占用高精度1us计时器(无需初始化)
 * @param 
 * @retval
 */
void SysTick_NO_EXTI_Delay_1us( __IO uint32_t us)
{
	uint32_t i;
...
/**
 * @brief 无中断类型高CPU占用高精度1ms计时器(无需初始化)
 * @param 传入要延时的10us
 * @retval 无
 */
